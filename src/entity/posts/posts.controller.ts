...
export class PostsController {
  ...
  @Get(':postId')
  @UseGuards(JwtAuthGuard) //TODO на время
  async getPostById(
  ...
  async createCommentsForPost(
    ...
    const newCommentId = await this.commentsService.createCommentForPost(postId, createCommentDto, userId);
  ...
  async setLikeStatus(
    ...
    return this.commandBus.execute(new LikePostCommand(userId, postId, likeDto.likeStatus));
  }
}
